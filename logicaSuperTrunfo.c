...
//menu
    ...
    break;
    case 2:
        printf("A regra do jogo consiste em dois jogaores, cada um registra sua carta, e carta com maior numero pontos vence!\n");
        printf(" o numero de pontos das cartas sao calculado pelos valores das estatisticas, sendo elas individuais ou somadas\n");
    break;
    case 3:
        printf("SAINDO...\n");
    break;
